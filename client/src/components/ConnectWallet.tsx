            ...
            {(() => {
              ...
              return (
                <div className="relative" ref={dropdownRef}>
                  ...
                  {showDropdown && (
                    <div className="absolute right-0 mt-2 w-48 bg-black border border-white/20 rounded-lg shadow-lg py-2 z-50">
                      <button
                        onMouseDown={(e) => {
                          e.preventDefault();
                          e.stopPropagation();
                      ...
                      <button
                        onMouseDown={(e) => {
                          e.preventDefault();
                          e.stopPropagation();
                          console.log('Clan button clicked');
                          setShowDropdown(false);
                          router.push('/clan');
                          console.log('Navigated to clan page');
                        }}
                        className="w-full px-4 py-3 text-left text-white hover:bg-white/10 transition-colors flex items-center gap-2 cursor-pointer"
                      >
                        <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
