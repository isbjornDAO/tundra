...
export function LiveSnowstormStream() {
            ...
            <div className="absolute inset-0 bg-gradient-to-br from-blue-900 via-purple-900 to-red-900">
              ...
              <div className="absolute inset-0 overflow-hidden">
                ...
                {Array.from({ length: 8 }, (_, i) => (
                  <div
                    key={`ui-${i}`}
                    className="absolute bg-white/20 rounded border border-white/30"
                    style={{
                      width: `${Math.random() * 60 + 20}px`,
                      height: `${Math.random() * 20 + 10}px`,
                      left: `${Math.random() * 80 + 10}%`,
                      top: `${Math.random() * 80 + 10}%`,
                      animation: `uiFloat ${Math.random() * 4 + 3}s ease-in-out infinite`,
