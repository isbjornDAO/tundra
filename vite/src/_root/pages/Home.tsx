...
import { ConnectWallet, LiveSnowstormStream, Navigation, SimpleTournamentMap, TournamentSetupGuide } from "@/components/shared";
               ...
               <main className="container-main py-8 relative z-20">
                       ...
                       <div className="card-interactive">
                           <div className="flex items-start gap-6">
                               ...
                               <div className="min-w-0">
                                   ...
                                   <Link to="/tournaments/register" className="inline-flex items-center text-red-400 hover:text-red-300 text-sm font-medium">
                                       Register Now
                       ...
                       <div className="card-interactive">
                           <div className="flex items-start gap-6">
                               ...
                               <div className="min-w-0">
                                   ...
                                   <Link to="/tournaments/bracket" className="inline-flex items-center text-blue-400 hover:text-blue-300 text-sm font-medium">
                                       View Matches
                                       <svg className="w-4 h-4 ml-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                           <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
                                       </svg>
                       ...
                       <div className="card-interactive">
                           <div className="flex items-start gap-6">
                               ...
                               <div className="min-w-0">
                                   ...
                                   <Link to="/tournaments/register" className="inline-flex items-center text-green-400 hover:text-green-300 text-sm font-medium">
                                       Choose Game
                                       <svg className="w-4 h-4 ml-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                           <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
                                       </svg>
                   ...
                   <div className="card text-center mb-24">
                       ...
                       <div className="flex flex-col sm:flex-row justify-center gap-4">
                           <Link to="/tournaments/register" className="btn btn-primary">
                               Get Started
                           </Link>
                           <Link to="/tournaments/bracket" className="btn btn-outline">
                               Learn More
                           </Link>
                       </div>
